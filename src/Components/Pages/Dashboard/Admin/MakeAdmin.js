...
const MakeAdmin = () => {
  ...
  // const { data: users, isLoading } = useQuery('users', () => fetch(`https://fierce-savannah-77217.herokuapp.com/user`, {
  //   method: "GET",
  //   headers: {
  ...
  useEffect(() => {
    fetch(`https://fierce-savannah-77217.herokuapp.com/user`, {
      method: "GET",
      headers: {
        "authorization": `Bearer ${localStorage.getItem("accessToken")}`
      }
  ...
  //  axios.get(`https://fierce-savannah-77217.herokuapp.com/user`, {
  //   headers: {
  //    "authorization": `Bearer ${localStorage.getItem("accessToken")}`
  //   }
  //  })
  ...
  const handelMakeAdmin = email => {
    fetch(`https://fierce-savannah-77217.herokuapp.com/user/admin/${email}`, {
      method: "PUT",
      headers: {
        "authorization": `Bearer ${localStorage.getItem("accessToken")}`
      }
